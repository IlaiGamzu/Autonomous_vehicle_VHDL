...
#   set_location_assignment  PIN_D13 -to clk ;#CLOCK_27
...
#   set_location_assignment  PIN_P26 -to EXT_CLOCK
   ...
   set_location_assignment PIN_G26  -to Reset  ;# KEY0	reset
   # set_location_assignment PIN_N23  -to KEY1  ;# KEY1	track1
   # set_location_assignment PIN_P23  -to KEY2  ;# KEY2	track0
#   set_location_assignment PIN_W26  -to KEY3  ;# KEY3
   ...
   set_location_assignment PIN_N25  -to track[0]   ;# SW[0]	dir0
   set_location_assignment PIN_N26  -to track[1]   ;# SW[1]	dir1
   # set_location_assignment PIN_P25  -to track[2]   ;# SW[2]	dir2
...
#   set_location_assignment PIN_T7   -to SW[13]  ;# SW[13]
  set_location_assignment PIN_U3   -to dir[0]  ;# SW[14]
  set_location_assignment PIN_U4   -to dir[1]  ;# SW[15] 	reset
  set_location_assignment PIN_V1   -to dir[2]  ;# SW[16]
   set_location_assignment PIN_V2   -to Estop  ;# SW[17] on the left side 	Estop
...
#   set_location_assignment PIN_L19  -to GPIO_0[35]
  ...
  set_location_assignment PIN_K25  -to outputFromEngines[0]
  set_location_assignment PIN_K26  -to outputFromEngines[1]
  set_location_assignment PIN_M22  -to outputFromEngines[2]
  set_location_assignment PIN_M23  -to outputFromEngines[3]
  set_location_assignment PIN_M19  -to outputFromEngines[4]
  set_location_assignment PIN_M20  -to outputFromEngines[5]
  set_location_assignment PIN_N20  -to outputFromEngines[6]
  set_location_assignment PIN_M21  -to outputFromEngines[7]
